...
--
-- Table structure for table `compra-venta`
--
...
--
-- Dumping data for table `compra-venta`
--

LOCK TABLES `compra-venta` WRITE;
/*!40000 ALTER TABLE `compra-venta` DISABLE KEYS */;
/*!40000 ALTER TABLE `compra-venta` ENABLE KEYS */;
UNLOCK TABLES;
